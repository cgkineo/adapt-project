...
class Framework {
   ...
   * @param {boolean} options.usePackageJSON
   * @param {string} options.schemaVersion
   * @param {function} options.log
   * @param {function} options.warn
   * @param {Object} options.schemasConfig
   * @param {Array|null} options.specifiedMenus
   * @param {Array|null} options.specifiedThemes
   */
  constructor ({
    ...
    /** @type {Array|null} */
    this.specifiedMenus = specifiedMenus
    /** @type {Array|null} */
    this.specifiedThemes = specifiedThemes
  }
  ...
  get pluginTypesPlural () {
    if (this.isSchemaVersionGte('1.0.0')) {
      return ['core', 'components', 'extensions', 'menu', 'theme']
    }
    return ['components', 'extensions', 'menu', 'theme']
  }

  get pluginTypesSingular () {
    if (this.isSchemaVersionGte('1.0.0')) {
      return ['core', 'component', 'extension', 'menu', 'theme']
    }
    return ['component', 'extension', 'menu', 'theme']
  }
  ...
  getSchemas ({
    includedFilter = this.includedFilter,
    schemasConfig = this.schemasConfig
  } = {}) {
  ...
  makeIncludeFilter () {
    ...
    const pluginTypes = this.pluginTypesPlural
    const sourcedir = 'src/'
  ...
  isSchemaVersionGte (version) {
    return semver.gte(this.schemaVersion, version)
  }
}
